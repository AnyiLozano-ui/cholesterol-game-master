...
export class GameScene extends Phaser.Scene {
    ...
    override update(_time: number, delta: number) {
        ...
        // const children = this.mountainHitboxes.getChildren() as Phaser.GameObjects.GameObject[];

        // for (let i = 0; i < children.length; i++) {
        //     const obj = children[i] as Phaser.GameObjects.Image;
        //     if (!obj || !obj.active || !obj.visible) continue;

        //     const isNeutralized = obj.getData('neutralized') === true;
        //     if (isNeutralized) continue;

        //     const mb = obj.getBounds();
        //     if (Phaser.Geom.Intersects.RectangleToRectangle(pb, mb)) {
        //         hit = true;
        //         break;
        //     }
        // }

        // if (hit && !this.justHitMountain) {
        //     this.onPlayerHitsMountain();
        // }
    }
